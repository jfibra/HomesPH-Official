...
import { Eye, EyeOff, Mail, Lock, User, Phone, Building2, ShieldCheck } from 'lucide-react'
...
const schema = z.object({
  ...
  company_name: z.string().min(2, 'Company/developer name is required.'),
...
export default function DeveloperRegisterForm() {
    ...
    <div className="w-full max-w-[540px]">
      <div className="bg-white rounded-xl border-t-[3px] border-[#0c1f4a] shadow-[0_4px_6px_rgba(12,31,74,0.04),0_10px_40px_rgba(12,31,74,0.10),0_30px_60px_rgba(12,31,74,0.06)] ring-1 ring-[#0c1f4a]/[0.05] px-8 sm:px-10 py-9 sm:py-10">
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h1 className="text-xl font-black text-[#0c1f4a] tracking-tight leading-tight">Developer Registration</h1>
            <p className="text-xs text-gray-500 mt-0.5">Real estate development company</p>
          </div>
        </div>
