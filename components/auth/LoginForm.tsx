          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full pl-10 pr-4 py-3.5 rounded-xl border text-[15px] text-gray-900 placeholder:text-gray-300 bg-gray-50/70 focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#0c1f4a]/20 focus:border-[#0c1f4a] hover:border-gray-300 transition-all duration-200 ${
                  errors.email
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                onChange={handleChange}
                placeholder="••••••••"
                className={`w-full pl-10 pr-12 py-3.5 rounded-xl border text-[15px] text-gray-900 placeholder:text-gray-300 bg-gray-50/70 focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#0c1f4a]/20 focus:border-[#0c1f4a] hover:border-gray-300 transition-all duration-200 ${
                  errors.password
                    ? 'border-rose-400 bg-rose-50/60 focus:ring-rose-200 focus:border-rose-400'
                    : 'border-gray-200'
                }`}
