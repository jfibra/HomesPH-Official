              ...
              {projects.map(p => {
                ...
                return (
                  <Link
                    ...
                    className="group bg-white rounded-xl border border-gray-200 hover:shadow-lg transition-all duration-300 flex flex-col md:flex-row overflow-hidden h-auto md:h-[316px] md:w-[941px] mx-auto lg:mx-0"
                  >
                    {/* Left Image Side */}
          ...
          <div className="hidden lg:flex flex-col gap-6 w-[300px] shrink-0">
            <div className="sticky top-24 space-y-6">
              ...
              <div className="flex flex-col items-center">
                ...
                <p className="text-[#7F7F7F] text-[15px] font-outfit font-light mt-2 text-center">Advertisement</p>
              </div>
            </div>
          </div>
        </div>
