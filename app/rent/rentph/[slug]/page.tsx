...
async function getProperty(slug: string): Promise<RentPHProperty | null> {
  try {
    ...
    // RentPH returns the property object directly or wrapped in data
...
export default async function RentPHPropertyPage({
  params,
}: {
            ...
            {coverImg || galleryImages.length > 0 ? (
              <div className="grid gap-2">
                ...
                <div className="relative rounded-2xl overflow-hidden h-[380px] bg-slate-100">
                  ...
                  <div className="absolute top-4 right-4 bg-[#1428ae]/90 backdrop-blur-sm text-white text-[11px] font-bold px-2.5 py-1 rounded-full tracking-wide">
                    RENT.PH
                  </div>
                </div>
