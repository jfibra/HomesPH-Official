...
export default function DashboardListingDetailLoading() {
  return (
    <div className="mx-auto flex max-w-7xl flex-col gap-6 p-6">
      <Card className="border-slate-200 shadow-sm"><CardContent className="space-y-4 px-6 py-6"><Skeleton className="h-12 w-80" /><Skeleton className="h-4 w-[32rem]" /></CardContent></Card>
